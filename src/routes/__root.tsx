...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Scroll a feed of macro-verified recipes, plan your week, and generate a shopping list in seconds." },
      { name: "author", content: "PrepFlow" },
      { property: "og:title", content: "PrepFlow — Meal Prep, Reimagined" },
      { property: "og:description", content: "Vertical recipe feed + weekly planner + auto shopping list." },
